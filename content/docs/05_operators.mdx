...
<SoplangCodeWindow title="arithmetic_operators.sop" code={`abn a = 10
abn b = 3
qor("Wadarta: " + (a + b))
qor("Hadhaaga: " + (a % b))`}/>
...
<SoplangCodeWindow title="comparison_operators.sop" code={`door a = 5
door b = 10
qor("a == b: " + (a == b))
qor("a < b: " + (a < b))`}/>
...
<SoplangCodeWindow title="logical_operators.sop" code={`abn x = 5
abn y = 10
