      ...
      <div className="container-custom py-12 md:py-20">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-20">
          {[
            ...
            {
              label: "GitHub Stars",
              value: communityStats.stars,
              icon: "lucide:star",
            },
            {
              label: "Forks",
              value: communityStats.forks,
              icon: "lucide:git-fork",
            },
            {
              label: "Downloads",
              value: (communityStats.downloads / 1000).toFixed(1) + "k+",
            ...
            <div
              key={i}
              className="p-6 rounded-2xl bg-card/50 backdrop-blur-sm border border-border text-center transition-colors w-full md:w-64"
            >
              <Icon
                icon={stat.icon}
                className="w-6 h-6 mx-auto mb-3 text-primary/60"
              />
          ...
          <div className="flex flex-wrap justify-center gap-6">
            {platforms.map((platform) => (
              ...
              >
                ...
                <div
                  className={`absolute inset-0 opacity-0 group-hover:opacity-5 transition-opacity bg-gradient-to-br ${platform.gradient}`}
                />

                <div className="p-6 flex flex-col h-full relative z-10">
                  <div
                    className={`w-12 h-12 rounded-xl flex items-center justify-center mb-4 bg-gradient-to-br ${platform.gradient} text-white shadow-lg`}
                  >
          ...
          <div className="relative overflow-hidden rounded-3xl bg-blue-800 text-white p-8 md:p-16 text-center">
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              ...
              <p className="text-lg md:text-xl text-primary-foreground/90 mb-10 leading-relaxed">
                ...
                contributions. Whether you're fixing bugs, improving docs, or
                helping others, every contribution matters.
              </p>
              ...
              <div className="grid sm:grid-cols-3 gap-4">
                ...
                >
                  <Icon
                    icon="lucide:git-pull-request"
                    className="w-8 h-8 mb-4 text-primary-foreground/80"
                  />
                  <h3 className="font-bold text-lg mb-1">Code</h3>
                  <p className="text-sm text-primary-foreground/90 group-hover:text-primary-foreground transition-colors">
                    Submit PRs and fix bugs
                  </p>
                </Link>
        ...
        <section className="max-w-4xl mx-auto">
          ...
          <div className="grid gap-6">
            <div className="p-6 bg-card rounded-2xl border border-border  transition-all">
