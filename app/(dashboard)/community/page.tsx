      ...
      <div className="container-custom py-12 md:py-20">
        ...
        <div className="text-center mb-20 relative">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-foreground mb-6 tracking-tight animate-fade-in-up animation-delay-100">
            Join the <span className="text-gradient-primary">Soplang Community</span>
          </h1>
        ...
        {/* Contribute Section */}
        <section className="mb-24">
          <div className="relative overflow-hidden rounded-3xl bg-gradient-primary text-primary-foreground p-8 md:p-16 text-center">
            {/* Decorative circles */}
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
              ...
              <div className="grid sm:grid-cols-3 gap-4">
                ...
                >
                  <Icon icon="lucide:git-pull-request" className="w-8 h-8 mb-4 text-primary-foreground/80" />
                  <h3 className="font-bold text-lg mb-1">Code</h3>
                  <p className="text-sm text-primary-foreground/90 group-hover:text-primary-foreground transition-colors">Submit PRs and fix bugs</p>
                </Link>
                ...
                <Link
                  ...
                  className="bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/10 rounded-xl p-6 text-left transition-all hover:-translate-y-1 group"
                >
                  <Icon icon="lucide:file-text" className="w-8 h-8 mb-4 text-primary-foreground/80" />
                  <h3 className="font-bold text-lg mb-1">Docs</h3>
                  <p className="text-sm text-primary-foreground/90 group-hover:text-primary-foreground transition-colors">Improve tutorials & guides</p>
                </Link>
                ...
                <Link
                  ...
                  className="bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/10 rounded-xl p-6 text-left transition-all hover:-translate-y-1 group"
                >
                  <Icon icon="lucide:bug" className="w-8 h-8 mb-4 text-primary-foreground/80" />
                  <h3 className="font-bold text-lg mb-1">Issues</h3>
                  <p className="text-sm text-primary-foreground/90 group-hover:text-primary-foreground transition-colors">Report bugs & ideas</p>
                </Link>
              </div>
            </div>
          </div>
