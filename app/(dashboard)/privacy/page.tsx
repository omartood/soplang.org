        ...
        <div className="bg-card border border-border rounded-2xl shadow-sm p-6 md:p-10">
          <div className="prose prose-lg dark:prose-invert max-w-none prose-headings:text-foreground prose-p:text-muted-foreground prose-strong:text-foreground prose-li:text-muted-foreground">
            <section className="mb-10 last:mb-0">
              ...
              <p>
                At Soplang, we take your privacy seriously. This Privacy Policy
                explains how we collect, use, disclose, and safeguard your
                information when you use our programming language, website, and
                related services.
              </p>
            </section>
            ...
            <section className="mb-10 last:mb-0">
              ...
              <ul className="grid sm:grid-cols-2 gap-4 not-prose pl-0 mt-6">
                {[
                  ...
                  <li
                    key={item}
                    className="flex items-center gap-3 text-muted-foreground bg-background/50 p-3 rounded-lg border border-border/50 hover:border-primary/30 transition-colors"
                  >
                    <Icon
                      icon="lucide:check"
            ...
            <section className="mb-10 last:mb-0">
              ...
              <p>
                ...
                information. You have the right to access, correct, delete, or
