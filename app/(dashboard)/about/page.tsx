      ...
      <div className="container-custom py-10 md:py-22">
        ...
        <div className="text-center max-w-4xl mx-auto mb-20 relative">
          ...
          <div className="relative inline-block">
            <Icon
              icon="lucide:quote"
              className="absolute -top-6 -left-8 w-12 h-12 text-primary/20 -z-10"
            />
            <p className="text-xl md:text-2xl text-muted-foreground font-light leading-relaxed animate-fade-in-up animation-delay-200 italic">
              "A Somali programming language designed to bring coding closer to
              Somali speakers and promote programming in the local language."
            </p>
        ...
        <div className="relative mb-24 animate-fade-in-up animation-delay-400">
          <div className="absolute inset-0 bg-primary/5 blur-2xl transform scale-y-90 -z-10" />
          <div className="bg-card/50 backdrop-blur-xl border border-border rounded-3xl p-8 md:p-12 shadow-2xl overflow-hidden relative">
            <div className="absolute top-0 right-0 w-64 h-64 bg-primary/5 rounded-full blur-3xl translate-x-1/3 -translate-y-1/3 pointer-events-none" />
            ...
            <div className="flex flex-col md:flex-row items-center gap-10 relative z-10">
              <div className="w-full md:w-1/2">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Soplang is the first Somali programming language, created to
                  make coding accessible to Somali speakers using native Somali
                  syntax and keywords.
                </p>
              </div>
              <div className="w-full md:w-1/2">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-24">
          ...
          <div className="group bg-card hover:bg-card/80 border border-border hover:border-primary/30 p-8 rounded-3xl transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
            ...
            <p className="text-sm text-muted-foreground">
              Started in{" "}
              <strong className="text-foreground">February 2023</strong>,
              officially released in{" "}
              <strong className="text-foreground">October 2023</strong>
            </p>
          </div>
          ...
          <div className="group bg-card hover:bg-card/80 border border-border hover:border-primary/30 p-8 rounded-3xl transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
            ...
            <p className="text-sm text-muted-foreground">
              Current <strong className="text-foreground">Interpreter</strong>{" "}
              is built with <strong className="text-foreground">Python</strong>,
              but the coming soon{" "}
              <strong className="text-foreground">Compiler</strong> will be
              using <strong className="text-foreground">Rust</strong>.
            </p>
          </div>
          ...
          <div className="group bg-card hover:bg-card/80 border border-border hover:border-primary/30 p-8 rounded-3xl transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              <strong className="text-foreground">Interpreter</strong>, and{" "}
              <strong className="text-foreground">VS Code Extension</strong>.
            </p>
          </div>
          ...
          <div className="group bg-card hover:bg-card/80 border border-border hover:border-primary/30 p-8 rounded-3xl transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
            ...
            <p className="text-sm text-muted-foreground">
              Promoting{" "}
              <strong className="text-foreground">digital inclusion</strong> and
              advancing Somali language development in tech.
            </p>
          </div>
        </div>
        ...
        <div className="relative rounded-3xl overflow-hidden bg-card border border-border">
          ...
          <div className="relative z-10 p-10 md:p-20 text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              ...
              that will revolutionize how you build with Soplang. Stay tuned for
              better performance, new features, and more.
            </p>
          </div>
        </div>
      </div>
