            ...
            <div className="container-custom py-10 md:py-20">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-20 animate-fade-in-up animation-delay-300">
                    <Link href="/docs" className="group">
                        <div className="bg-card/50 backdrop-blur-sm border border-border hover:border-primary/50 p-8 rounded-3xl h-full transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                    ...
                    <Link href="/tutorials" className="group">
                        <div className="bg-card/50 backdrop-blur-sm border border-border hover:border-primary/50 p-8 rounded-3xl h-full transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                            ...
                            <h3 className="text-xl font-bold mb-3 group-hover:text-primary transition-colors">Tutorials</h3>
                            <p className="text-muted-foreground mb-4">
                    ...
                    <Link href="/faq" className="group">
                        <div className="bg-card/50 backdrop-blur-sm border border-border hover:border-primary/50 p-8 rounded-3xl h-full transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                            ...
                            <h3 className="text-xl font-bold mb-3 group-hover:text-primary transition-colors">FAQ</h3>
                            <p className="text-muted-foreground mb-4">
