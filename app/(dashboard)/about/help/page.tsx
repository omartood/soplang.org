      ...
      <div className="container-custom py-10 md:py-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-20 animate-fade-in-up animation-delay-300">
          <Link href="/docs" className="group">
            <div className="bg-card/50 backdrop-blur-sm border border-border  p-8 rounded-3xl h-full transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
              ...
              <p className="text-muted-foreground mb-4">
                Comprehensive guides, API references, and language syntax
                documentation.
              </p>
          ...
          <Link href="/tutorials" className="group">
            <div className="bg-card/50 backdrop-blur-sm border border-border  p-8 rounded-3xl h-full transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
              ...
              <p className="text-muted-foreground mb-4">
                Step-by-step guides to build your first applications with
                Soplang.
              </p>
              <div className="flex items-center text-sm font-medium text-primary">
          ...
          <Link href="/faq" className="group">
            <div className="bg-card/50 backdrop-blur-sm border border-border  p-8 rounded-3xl h-full transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
              ...
              <p className="text-muted-foreground mb-4">
                Answers to frequently asked questions about installation,
                features, and more.
              </p>
              <div className="flex items-center text-sm font-medium text-primary">
                <span>View FAQ</span>
        ...
        <div className="relative rounded-3xl overflow-hidden animate-fade-in-up animation-delay-400">
          <div className="absolute inset-0 bg-muted/80 border border-border/50" />
          ...
          <div className="relative z-10 p-10 md:p-16 flex flex-col md:flex-row items-center justify-between gap-10">
            <div className="text-center md:text-left">
              ...
              <p className="text-muted-foreground max-w-xl text-lg">
                Join our community on Discord or create an issue on GitHub. We
                are here to help you build amazing things.
              </p>
            </div>
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >
                <Icon
                  ...
                  className="w-5 h-5 brightness-0 invert dark:invert-1"
                />
